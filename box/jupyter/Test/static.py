...
#write tile ------write_fun write_node
...
move_start=[3000,1000,0];
result=move_fun(move_start,width)
produce_s(fileobj,result,0);

move_start=[11000,1000,0]
result=move_fun(move_start,width)
produce_s(fileobj,result,5);

move_start=[3000,9000,0]
result=move_fun(move_start,width)
produce_s(fileobj,result,10);

move_start=[11000,9000,0]
result=move_fun(move_start,width)
