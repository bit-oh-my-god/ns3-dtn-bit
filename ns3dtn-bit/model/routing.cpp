...
namespace ns3 {
    ...
    namespace ns3dtnbit {
        ...
        void YouRouting::GetInfo(node_id_t destination_id, node_id_t from_id, 
        ...
        map<int, vector<int>> id2cur_exclude_vec_of_id, 
    ...
    namespace ns3dtnbit {
        ...
        void TegRouting::GetInfo(node_id_t destination_id, node_id_t from_id, 
        std::vector<node_id_t> vec_of_current_neighbor, node_id_t own_id, 
        dtn_time_t expired_time, int bundle_size, int networkconfigurationflag, 
        map<int, vector<int>> id2cur_exclude_vec_of_id, 
        dtn_time_t local_time, dtn_seqno_t that_seqno) {
