    ...
    namespace ns3dtnbit {
        ...
        class CGRRouting : public RoutingMethodInterface {
            ...
            void GetInfo(node_id_t destination_id, node_id_t from_id, std::vector<node_id_t> vec_of_current_neighbor,
                    node_id_t own_id, dtn_time_t expired_time, int bundle_size, int networkconfigurationflag = 0) override {
                ...
                for (auto m : cgr_xmit_vec) {
                    ...
                    if (time_before) {
                        ...
                        if (s_is_in_neighbor) {
                            ...
                            int residual_capacity = (m.contact_end_time_ - m.contact_start_time_) * m.data_transmission_rate_;
